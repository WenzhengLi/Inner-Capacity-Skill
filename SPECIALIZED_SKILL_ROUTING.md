...
1. `CULTURAL_MODEL_MODULES.md`
2. `STORY_TRAINING_PLAN.md`
3. `ASSESSMENT_PROTOCOL.md`
4. `HEALTH_AND_DESTINY_MODULES.md`

规则：

- 历史人物分析不做简单道德评判，要拆局势、经历、身体、性格、利益和时代约束。
- 地域财富分析不浪漫化任何地域，要拆钱从哪里来、如何流动、如何分配、如何违约惩罚、如何退出。
- 格物养身只做身体观察和低风险生活建议，不做医学诊断、开药、改药。
- 这些材料可以进入故事训练、动态 50 题和每日复盘。
