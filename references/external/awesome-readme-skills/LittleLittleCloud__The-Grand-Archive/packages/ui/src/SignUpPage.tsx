      ...
      <div className="min-h-screen bg-surface flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="bg-surface-low p-8" style={{ boxShadow: "var(--shadow-whisper)" }}>
            ...
            <p className="font-body text-sm text-on-surface-variant text-center leading-relaxed">
              We sent a verification link to <span className="text-on-surface font-medium">{email}</span>.
        ...
        <div className="bg-surface-low p-8" style={{ boxShadow: "var(--shadow-whisper)" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                Password{" "}
                <span className="normal-case tracking-normal text-on-surface-variant/60">(min 8 chars)</span>
              </label>
              <input
                id="password"
                type="password"
